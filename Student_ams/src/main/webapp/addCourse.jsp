<%@ page import="com.course.entity.Student" %>      <%--引入课程实体类--%>
<%@ page import="com.course.controller.AdminController" %>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="${pageContext.request.contextPath}/index">学生在线选课系统</a>
                </div>
