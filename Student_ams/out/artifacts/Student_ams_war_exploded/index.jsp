<%@ page import="com.course.entity.Course" %>
<%@ page import="java.util.List" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<html>

    <%--
        showAllClasses 和 showMyClasses 对应com.course.controller包中的DisplayController类
    --%>
    ...
    <body role="document">
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="${pageContext.request.contextPath}/index.jsp">学生在线选课系统</a>     <%--加了个/--%>
                </div>
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="${pageContext.request.contextPath}/index.jsp">主页</a></li>
                        <%-- com.course.controller.DisplayController showAllClzs --%>
                        <li><a href="${pageContext.request.contextPath}/showAllClasses">所有课程</a></li>
                        <%-- com.course.controller.DisplayController showMyClzs --%>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a><%=id%> 欢迎您!</a></li>
                        <li><a id="change" href="#" data-toggle="modal" data-target="#myModal">修改密码</a></li>
        ...
        <div class="container theme-showcase" role="main">
            ...
            <div class="alert alert-success" style="margin-top: 50px" role="alert">
                ...
                <%--背景图在jumbotron中--%>
                <div class="jumbotron" style="height: 350px; color: #b9def0;">
                    <h1>欢迎登陆学生在线选课系统!</h1>
                    <p>welcome to students online course selection system!</p>
                </div>

                <div class="container">
                    <ol class="breadcrumb" style="margin-top: 10px">
                        <li class="active" style="color: #2b542c">已有选课</li>
                    </ol>
                    <!-- 列的示例行 -->
                    <div class="row">
                        <%
                        ...
                        <div class="col-md-4">
                            ...
                            <h2><%=clz.getName()%></h2>
                            <p>授课老师:<%=clz.getBelong()%></p>
                            <p><%=clz.getDetail()%></p>
                            <p>
                                <a class="btn btn-default" href="${pageContext.request.contextPath}/showDetail?id=<%=clz.getId()%>" role="button">查看详情 &raquo;</a>
                            </p>
                        </div>
                        <%
                                }
