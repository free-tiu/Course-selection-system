<%@ page import="com.course.entity.Student" %>
<%@ page import="java.util.List" %>
<%@ page import="com.course.entity.StudyInfo" %>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="${pageContext.request.contextPath }/">学生在线选课系统</a>
                </div>
        ...
        <div class="container theme-showcase" role="main">
            ...
            <div class="alert alert-success" style="margin-top: 50px" role="alert">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-success" data-toggle="modal" data-target="#myModal">添加选课记录
                                </button>
                            </td>
                        </tr>
                    </tbody>
                ...
                <div class="col-md-12 text-right">
                    <yyf:page url="${pageContext.request.contextPath }/chooseManage"></yyf:page>    <%-- 分页标签 --%>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">添加选课记录</h4>
                        </div>
